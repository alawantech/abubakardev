...
const Dashboard = () => {
  ...
  const fetchEnrollments = async () => {
    try {
      ...
      console.log(
        "Dashboard: Found enrollment plans:",
      ...
      const enrollmentsData = await Promise.all(
        enrollmentsSnapshot.docs.map(async (enrollmentDoc) => {
          ...
          const paymentData =
            paymentsSnapshot.docs.length > 0
      ...
      const deduplicatedEnrollments = enrollmentsData.reduce(
        (acc, enrollment) => {
          ...
          if (!existing) {
            ...
            const existingIsPaid =
              existing.payment &&
              (existing.payment.status === "approved" ||
      ...
      const cleanupDuplicates = async () => {
        try {
          ...
          if (duplicates.length > 0) {
            console.log(
              "Dashboard: Cleaning up duplicate enrollment plans:",
            ...
            const deletePromises = duplicates.map(async (duplicate) => {
              try {
                ...
                console.log(
                  "Dashboard: Deleted duplicate enrollment plan:",
                  duplicate.id,
                );
              } catch (error) {
                console.error(
                  "Dashboard: Failed to delete duplicate enrollment plan:",
                  duplicate.id,
                  error,
                );
              }
      ...
      console.log(
        "Dashboard: Final enrollments data:",
        deduplicatedEnrollments,
      );
  ...
  const fetchPaymentHistory = async () => {
    ...
    try {
      ...
      const allPayments = [...paymentsData, ...enrollmentPaymentsData].sort(
        (a, b) => {
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">
                      {bankDetails?.accountName || "ZedroTech"}
                    </p>
                  </div>
                  <div>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
                ...
                <ol className="space-y-2 text-blue-800">
                  ...
                  <li>
                    4. Your access will be restored once payment is verified
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div
                    onClick={() =>
                      document.getElementById("renewal-receipt-upload").click()
                    }
                      ...
                      {receiptPreview && (
                        <div className="border-2 border-gray-200 rounded-lg p-4 bg-white">
                          ...
                          <p className="text-xs text-gray-500 mt-2 text-center">
                            This is how your receipt will appear to our
                            verification team
                          </p>
                        </div>
                      )}
              ...
              <p className="text-xs text-gray-500 text-center">
                🔒 Your payment receipt will be securely stored and reviewed by
                our team
              </p>
            </div>
          </div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setVisibleSections((prev) => ({
                            ...prev,
                            subscriptionDetails: e.target.checked,
                          }))
                        }
                        ...
                        <label className="flex items-center justify-between p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setVisibleSections((prev) => ({
                                ...prev,
                                extendSubscription: e.target.checked,
                              }))
                            }
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M9 14l6-6m-6 0l6 6m2-10h-1a2 2 0 00-2 2v10a2 2 0 002 2h1m-6-4h4"
                          />
                        </svg>
                        <span className="font-medium text-gray-900">
                          Payment History
          ...
          <div className="mb-8 bg-white rounded-3xl shadow-xl p-8 border-2 border-indigo-100">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-lg text-gray-900">
                  {userData?.whatsappNumber || "Not set"}
                </p>
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-600 mb-1">
        ...
        {(() => {
          const pendingEnrollments = enrollments.filter((enrollment) => {
            ...
            const paymentApproved =
              enrollment.payment?.status === "approved" ||
              enrollment.paymentStatus === "paid";
            return !paymentApproved; // include enrollments that are not paid/approved
          });

          if (pendingEnrollments.length > 0) {
            return (
              <div className="mb-8 bg-yellow-50 rounded-3xl shadow p-6 border border-yellow-200">
                <h2 className="text-lg font-bold text-yellow-700 mb-4">
                  🔔 Pending Payments
                </h2>
                <p className="text-sm text-yellow-800 mb-4">
                  We found registrations that still require payment. Complete
                  payment to activate your access.
                </p>
                <div className="space-y-3">
                    ...
                    >
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {(enrollment.planType || "monthly").toUpperCase()} — ₦
                      ...
                      <div>
                        <button
                          ...
                          onClick={() =>
                            navigate(`/course/${enrollment.courseId}/payment`, {
                              state: {
                                plan: {
                                  type: enrollment.planType || "monthly",
                                  amount: enrollment.planAmount || 0,
        ...
        {visibleSections.subscriptionDetails &&
          (() => {
            ...
            const paidEnrollments = enrollments.filter((enrollment) => {
              ...
              const paymentApproved = enrollment.payment?.status === "approved";
              return (
                hasPayment && (paymentApproved || paymentStatus === "paid")
              );
            });
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    {paidEnrollments[0].planType === "monthly" && (
                      <div className="bg-white rounded-xl p-6 shadow-md">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          {paymentCountdown > 0
                            ? `${paymentCountdown} days remaining`
                            : "Due today"}
                        </p>
                      </div>
                    )}
                ...
                <div className="mb-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl shadow-xl p-8 border-2 border-green-200">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-md">
                    <p className="text-gray-700 mb-4">
                      Pay ahead to extend your subscription and ensure
                      uninterrupted access to your courses. Your current
                      subscription will automatically continue when it expires.
                    </p>
                          ...
                          >
                            ...
                            <div className="p-6">
                              ...
                              <div className="space-y-2 mb-4">
                                ...
                                {remaining && (
                                  <div
                                    className={`flex items-center gap-2 text-sm ${isExpired ? "text-red-600" : "text-green-600"}`}
                                  >
                                    <svg
                                      className="w-4 h-4"
                                      fill="currentColor"
                          ...
                          <div className="p-6">
                            ...
                            <div className="bg-yellow-100 border border-yellow-300 rounded-xl p-4 mb-4">
                                ...
                                <div className="bg-white rounded-lg p-3 mb-3 border border-yellow-200">
                                  ...
                                  <div className="text-xs text-gray-600 space-y-1">
                                    ...
                                    <div>
                                      ...
                                      {enrollment.planAmount?.toLocaleString() ||
                                        "30,000"}
                                    </div>
                                  </div>
                                </div>
                              ...
                              <button
                                onClick={() =>
                                  navigate(
                                    `/course/${enrollment.courseId}/payment`,
                                    {
                                      state: {
                                        plan: {
        ...
        {visibleSections.browseMore && (
          <div className="mt-12 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 text-center border-2 border-indigo-200">
            ...
            <p className="text-gray-600 mb-6">
              Explore our catalog and enroll in more courses
            </p>
            <button
              onClick={() => navigate("/courses")}
                    ...
                    paymentHistory.forEach((payment) => {
                      ...
                      if (payment.type === "enrollment") {
                        ...
                        const enrollment = enrollments.find(
                          (e) => e.customerEmail === payment.userEmail,
                        );
