...
const CourseManagement = () => {
  ...
  const [courseData, setCourseData] = useState({
    ...
    pricingModel: "free",
    price: "",
    // New: support tiered pricing
    pricing: {
      monthly: "",
      yearly: "",
    },
    displayPricing: "monthly", // which price to show to students (monthly/yearly/one-time)
    topics: [],
    // New fields
    whatYouWillLearn: [],
    targetAudience: [],
  ...
  const handleSaveCourse = async () => {
    try {
      ...
      const cleanedData = {
        ...
        // Preserve one-time legacy price but also store new pricing object
        price: courseData.price,
        pricing: {
          monthly: courseData.pricing.monthly
            ? parseInt(
                String(courseData.pricing.monthly).replace(/[^0-9]/g, ""),
              )
            : null,
          yearly: courseData.pricing.yearly
            ? parseInt(String(courseData.pricing.yearly).replace(/[^0-9]/g, ""))
            : null,
        },
        displayPricing: courseData.displayPricing,
        topics: courseData.topics, // Include topics/curriculum
        whatYouWillLearn: courseData.whatYouWillLearn.filter(
          (item) => item.trim() !== "",
        ),
        targetAudience: courseData.targetAudience.filter(
          (item) => item.trim() !== "",
        ),
        courseDurationMonths: courseData.courseDurationMonths,
        materialsIncluded: courseData.materialsIncluded.filter(
          (item) => item.trim() !== "",
        ),
        requirements: courseData.requirements.filter(
          (item) => item.trim() !== "",
        ),
      };
  ...
  const handleEditCourse = (course) => {
    ...
    setCourseData({
      ...
      price: course.price || "",
      pricing: course.pricing || { monthly: course.price || "", yearly: "" },
      displayPricing: course.displayPricing || "monthly",
  ...
  const deleteTopic = (topicIndex) => {
    if (window.confirm("Are you sure you want to delete this topic?")) {
      const updatedTopics = courseData.topics.filter(
                      ...
                      <div className="course-featured-image">
                        {playingVideo === course.id && course.introVideoUrl ? (
                          ...
                          <div
                            ...
                            onClick={() =>
                              course.introVideoUrl && handlePlayVideo(course.id)
                            }
                          >
                            <img
                    ...
                    <div className="course-details">
                      {course.topics?.length > 0 ? (
                            ...
                            <div className="lessons-list">
                              {topic.lessons?.map((lesson, lessonIdx) => (
                                <div key={lessonIdx} className="lesson-detail">
                                  <strong>
                                    Lesson {lessonIdx + 1}: {lesson.name}
                                  </strong>
                                  {lesson.videoUrl && (
                        ...
                        <p className="no-curriculum">
                          No curriculum added yet. Click "Manage Curriculum" to
      ...
      {(view === "create-course" || view === "edit-course") && (
        <div className="course-form-container">
          <div className="form-header">
            <h3>
              {view === "edit-course" ? "Edit Course" : "Create New Course"}
            </h3>
          ...
          <div className="course-form-card">
            <div className="form-body">
                  ...
                  <>
                    <div className="form-group">
                      ...
                      <small className="field-hint">
                        Set the monthly subscription price shown to students if
                        display is set to monthly.
                      </small>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      />
                      <small className="field-hint">
                        Set the yearly price (e.g., a discounted annual rate).
                      </small>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      />
                      <small className="field-hint">
                        Legacy one-time price (optional). Use if you offer a
                        one-off purchase.
                      </small>
                    </div>

                    <div className="form-group">
                      <label>Display Price To Students</label>
                      <select
                        value={courseData.displayPricing}
                        onChange={(e) =>
                          setCourseData({
                            ...courseData,
                            displayPricing: e.target.value,
                          })
                        }
                      >
                ...
                <div className="image-upload-section">
                  <div className="upload-options">
                    <div className="upload-option">
                      ...
                      <small className="field-hint">
                        Upload from your device (max 5MB)
                      </small>
                    </div>
              ...
              <div className="form-group">
                ...
                <small className="field-hint">
                  Enter one benefit per line. Students will see key takeaways
                  before enrolling.
                </small>
                <textarea
              ...
              <div className="form-group">
                ...
                <small className="field-hint">
                  One line per target audience. Who will benefit most from this
                  course?
                </small>
                <textarea
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCourseData({
                      ...courseData,
                      courseDurationMonths: parseInt(e.target.value) || 0,
                    })
                  }
                  placeholder="0"
                  min="0"
                ...
                />
                <small className="field-hint">
                  Enter duration in months (e.g., 1, 2.5, 3, 6, etc.)
                </small>
              </div>
              ...
              <div className="form-group">
                ...
                <small className="field-hint">
                  List assets provided to students (one per line). E.g.,
                  downloadable resources, certificates, etc.
                </small>
                <textarea
              ...
              <div className="form-group">
                ...
                <small className="field-hint">
                  Additional requirements or instructions for students (one per
                  line).
                </small>
                <textarea
                    ...
                    <div key={topicIndex} className="topic-card">
                      ...
                      <div className="lessons-container">
                        <Reorder.Group
                          ...
                          onReorder={(newOrder) =>
                            updateTopic(topicIndex, "lessons", newOrder)
                          }
                            ...
                            >
                              ...
                              <div>
                                ...
                                <button
                                  className="btn-delete"
                                  onClick={() =>
                                    deleteLesson(topicIndex, lessonIndex)
                                  }
                                >
                                  Delete
                                </button>
            ...
            <div className="form-body">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTempLesson({ ...tempLesson, name: e.target.value })
                  }
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTempLesson({ ...tempLesson, videoUrl: e.target.value })
                  }
                  placeholder="https://www.youtube.com/watch?v=..."
                />
              </div>
              ...
              <div className="form-group">
                ...
                >
                  Use the editor below to add text, links, and formatted content
                  for this lesson.
                </small>
                <ReactQuill
                  theme="snow"
                  ...
                  onChange={(value) =>
                    setTempLesson({ ...tempLesson, description: value })
                  }
                  modules={modules}
