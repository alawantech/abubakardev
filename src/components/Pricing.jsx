      ...
      <div className="container pricing-fade-in">
        ...
        <div className="pricing-help pricing-stagger" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="pricing-fineprint">
            <p>
              <strong>Please note:</strong> All prices shown are one-time development fees only. Any third-party services your project requires — such as hosting, domain names, email services, payment gateways, VTU API providers (data/airtime/electricity), SMS providers, or other subscription-based tools — are billed separately and paid directly by you (the project owner). We help you set up and integrate these services, but their ongoing subscription costs are not included in our development price.
              <br/><br/>
