...
import { FaMobile, FaArrowRight, FaGlobe, FaSpinner, FaCheck, FaClock } from 'react-icons/fa';
...
const PricingMobile = () => {
  ...
  const pricing = pricingByService.mobile?.tiers || [];
    ...
    <div className="third-party-note">
      ...
      <div className="note-content">
        ...
        <p>
          ...
          Any third-party services required for your project — such as <strong>cloud hosting</strong> (AWS, Vercel, DigitalOcean),
          ...
          <strong>push notification services</strong> (Firebase, OneSignal),
          <strong>App Store / Play Store developer accounts</strong> ($25 Google, $99 Apple/year),
          <strong>database services</strong> (MongoDB Atlas, Supabase, PlanetScale),
          <strong>CDN/edge services</strong>, <strong>external API subscriptions</strong>, or any other
          <strong>external infrastructure</strong> — are billed directly by those providers and are <strong>your responsibility</strong>.
